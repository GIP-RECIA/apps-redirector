...
- Private config lives in a separate repo (`../esco-apps-redirector-conf`) deployed by its own `deploy-conf.sh`. This repo's deploy script excludes private conf and logs.
